...
-- Procedimiento para actualizar el inventario despu�s de una venta
...
BEGIN
    ...
    -- Detalle de productos m�s vendidos
    SELECT TOP 10
        p.ID_Producto,
        p.Nombre_Producto,
...
BEGIN
    ...
    BEGIN TRY
        ...
        BEGIN
            ...
            ROLLBACK TRANSACTION;
            RAISERROR('El cliente ya existe con el mismo teléfono, Instagram o email.', 16, 1);
            RETURN;
        END
